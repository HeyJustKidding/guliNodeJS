  ...
  <div>
    ...
    <div v-swiper:mySwiper="swiperOption">
      <div class="swiper-wrapper">
        ...
        >
          <a target="_blank" :href="banner.linkUrl">
            <img width="80%" height="20%" :src="banner.imageUrl" :alt="banner.title" />
          </a>
        </div>
      </div>
        ...
        <section class="container">
          ...
          <div>
            <article class="comm-course-list">
              <ul class="of" id="bna" >
                <li v-for="course in popularCourses" :key=course.id>
                  <div class="cc-l-wrap">
        ...
        <section class="container">
          ...
          <div>
            <article class="i-teacher-list">
              <ul class="of">
                <li v-for="teacher in popularTeachers" :key="teacher.id">
...
export default {
  ...
  methods: {
    ...
    getIndex(){
      index.getPopularCourseAndTeacher().then(response =>{
        this.popularCourses = response.data.data.courses
        this.popularTeachers = response.data.data.teachers
      })
    },

    getInfoFromToken(){
      login.getInfoFromToken()
    }
  },
};
</script>